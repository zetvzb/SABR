...
library(tidyr)
TJSurgeries <- extract(TJSurgeries, Player, c("FirstName", "LastName"), "([^ ]+) (.*)")
#renamevariablesnames
mergedTJSet <- merge(TJSurgeries, MasterBio1, by.x=c("LastName", "FirstName"), by.y=c("nameLast", "nameFirst"))
